...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MyTcpServer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 54, 9)
    ...
    "MyTcpServer\0clientChanged\0\0newConnection\0"
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTcpServer::clientChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyTcpServer::clientChanged()
{
