...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DownloadWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 63, 12),
QT_MOC_LITERAL(5, 76, 16)
    },
    "DownloadWindow\0on_browse_clicked\0\0"
    "on_start_downloading_clicked\0valueChanged\0"
    "fileTransferDone\0"
};
...
void DownloadWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_start_downloading_clicked(); break;
        case 2: _t->valueChanged(); break;
        case 3: _t->fileTransferDone(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject DownloadWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_DownloadWindow.data,
      qt_meta_data_DownloadWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DownloadWindow.stringdata))
